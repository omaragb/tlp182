...
namespace DafnyLanguage
{
  ...
  {
    public RunVerifierThreadParams(Dafny1.Program i_program, ITextSnapshot i_snapshot, string i_requestId, ResolverTagger i_errorListHolder, bool i_diagnoseTimeouts)
    {
      program = i_program;
      snapshot = i_snapshot;
  ...
  public class ProgressTagger : ITagger<ProgressGlyphTag>, IDisposable
  {
    ...
    void RunVerifier(Dafny1.Program program, ITextSnapshot snapshot, string requestId, ResolverTagger errorListHolder, bool diagnoseTimeouts) {
