...
namespace DafnyLanguage
{
  ...
  {
    public readonly Dafny1.Program Program;
    public DafnySuccessResolverTag(Dafny1.Program program)
    {
      Program = program;
    }
  }
  ...
  public sealed class ResolverTagger : ITagger<IDafnyResolverTag>, IDisposable
  {
    ...
    public Dafny1.Program Program;  // non-null only if the snapshot contains a Dafny program that type checks
